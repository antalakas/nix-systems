...
in
{
  options.my.sshTint = {
    ...
    label = lib.mkOption {
      ...
      description = ''
        ...
        host also needs a window-rule added by hand to *both*
        dotfiles/niri/config-home.kdl and config-office.kdl — nothing here
        generates those.
      '';
    };
  ...
  config = lib.mkIf cfg.enable {
    programs.zsh.initContent = ''
      ...
      # which is what the precmd reset in hosts/nixos/home.nix is for.
